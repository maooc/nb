...
@test "'browse --container -g tag2 --and -g tag3' performs AND search." {
  {
    "${_NB}" init
  ...
  run "${_NB}" browse --container -g tag2 --and -g tag3
...
@test "'browse --container -g tag2,tag3' performs AND search." {
  {
    "${_NB}" init
  ...
  run "${_NB}" browse --container -g tag2,tag3
...
@test "'browse --container -g tag2 --or -g tag3' performs OR search." {
  {
    "${_NB}" init
  ...
  run "${_NB}" browse --container -g tag2 --or -g tag3
...
@test "'browse --container -g tag2 -g tag3' performs AND search." {
  {
    "${_NB}" init
  ...
  run "${_NB}" browse --container -g tag2 -g tag3
...
@test "'browse --container -g tag1' performs search." {
  {
    "${_NB}" init
  ...
  run "${_NB}" browse --container -g tag1
