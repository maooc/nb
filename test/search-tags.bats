...
@test "'search -g tag2/child-2/grandchild-2' and similar exits with status 0 and print matches." {
  {
    "${_NB}" init
...
@test "'search -g tag1/child-1/grandchild-1' exits with status 0 and prints matches." {
  {
    "${_NB}" init
...
1.*:.*Content\ #tag2/child-2/grandchild-2\ Seven.\ #tag3/child-3/grandchild-3\ .*#tag1/child-1.*/grandchild-1                           ]]
  ...
  run "${_NB}" search -g tag1/child-1/grandchild-1
...
@test "'search -g tag1 --and -g tag2,'#tag3' exits with status 0 and prints matches as an AND query." {
  {
    "${_NB}" init
  ...
  run "${_NB}" search -g tag1 --and -g tag2,'#tag3'
...
@test "'search -g tag1 --or -g tag2,'#tag3' exits with status 0 and prints matches as an OR query." {
  {
    "${_NB}" init
  ...
  run "${_NB}" search -g tag1 --or -g tag2,'#tag3'
...
@test "'search -g tag1 --or --tags tag2 exits with status 0 and prints matches as an OR query." {
  {
    "${_NB}" init
  ...
  run "${_NB}" search -g tag1 --or --tags tag2
...
@test "'search -g tag1 -g tag2 exits with status 0 and prints matches as an AND query." {
  {
    "${_NB}" init
